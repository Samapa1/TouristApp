...
export const coordinateData = z.array(z.object({
  name: z.string(),
  lat: z.number(),
  lon: z.number(),
},
...
export type CoordinateData = z.infer<typeof coordinateData>

export const toCoordinateData = (data: unknown): CoordinateData => {
  return coordinateData.parse(data)
}
